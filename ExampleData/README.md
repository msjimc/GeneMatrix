...
|Sequence.gb|A set of GenBank mitochondrion genome entries for the Chelonoidis genus as generated in the [Guide > obtaining data](../Guide/obtainingFiles.md) document. This files is used as the basis of the [Tutorial](../Guide/tutorial.md)|
